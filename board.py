...
class Chessboard(object):
	...
	def init(self):
		...
		while(square_index <= 64):
			...
			if(file_index%8==0): file_index = 1
			else: file_index += 1
	...
	def calc_piece_pos_moves(self, piece, pos, color):
		...
		if(piece=='b' or piece=='B'):
			...
			while(valid):
				...
				if(self.board_index[square_ref]['color']==og_color):
					directions+=1
					index = og_pos_index
					if(directions==1): curr_square = index + 9
					elif(directions==2): curr_square = index - 7
					elif(directions==3): curr_square = index + 7
					...
					if(directions==0): curr_square = index - 9
					elif(directions==1): curr_square = index + 9
					elif(directions==2): curr_square = index - 7
					elif(directions==3): curr_square = index + 7
		...
		if(piece=='r' or piece=='R'):
			...
			while(valid):
				...
				if(self.board_index[square_ref]['color']==og_color):
					directions+=1
					index = og_pos_index
					if(directions==1): curr_square = index + 8
					elif(directions==2): curr_square = index - 1
					elif(directions==3): curr_square = index + 1
				elif(self.board_index[square_ref]['color']==op_color):
					possible_moves.append(square_ref)
					directions+=1
					index = og_pos_index
					...
					possible_moves.append(square_ref)
					index = self.board_index[square_ref]['index']
					if(directions==0): curr_square = index - 8
					elif(directions==1): curr_square = index + 8
					elif(directions==2): curr_square = index - 1
					elif(directions==3): curr_square = index + 1
		...
		if(piece=='p' or piece=='P'):
			...
			if(color=='w'):
				...
				if(pos[1]=='2'):
					if(self.board_index[self.get_ref_from_index(two_ahead_index)]['type']==None and self.board_index[self.get_ref_from_index(one_ahead_index)]['type']==None):
					...
					elif(self.board_index[self.get_ref_from_index(two_ahead_index)]['type']!=None and self.board_index[self.get_ref_from_index(one_ahead_index)]['type']==None):
						possible_moves.append(self.get_ref_from_index(one_ahead_index))
						return possible_moves
					elif(self.board_index[self.get_ref_from_index(two_ahead_index)]['type']==None and self.board_index[self.get_ref_from_index(one_ahead_index)]['type']!=None):
						return []
				if(r_diag!=None):
					if(self.board_index[r_diag]['color']!=self.board_index[pos]['color'] and self.board_index[r_diag]['type']!=None):
						possible_moves.append(r_diag)

				if(l_diag!=None):
					if(self.board_index[l_diag]['color']!=self.board_index[pos]['color'] and self.board_index[l_diag]['type']!=None):
